...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    cat5 = Category.create(name: 'Vodka')
    cat6 = Category.create(name: 'Whisky')
    cat7 = Category.create(name: 'Amaro')
