...
ActiveRecord::Schema.define(version: 2020_10_20_161937) do
  ...
  create_table "cocktail_recipes", force: :cascade do |t|
    ...
    t.index ["cocktail_id"], name: "index_cocktail_recipes_on_cocktail_id"
  end
  ...
  add_foreign_key "cocktail_recipes", "cocktails"
end
